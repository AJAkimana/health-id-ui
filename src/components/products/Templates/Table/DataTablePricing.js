...
import TablePricingToolBar from './TablePricingToolBar';
...
import { getSortedData } from '../../PricingFilter';

export class DataTablePricing extends Component {
  state = {
    selected: [],
...
export default withStyles(TableStyles)(DataTablePricing);
